...
<head>
    ...
    <title>Login | Aplikasi CutiOnline</title>
    <!-- Custom CSS -->
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img  src="mycss/logo.png" alt="logo" width="65%" /></span>
                    </div>
                    <!-- Form -->
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        ...
                                        <a href="{{route('register')}}"><button class="btn btn-success float-right" type="button"><i class="fa fa-lock m-r-5"></i>Register</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
